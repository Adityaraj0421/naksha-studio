...
```
A virtual design team for Claude Code — 22 specialist roles, 39 commands, 11,000+ lines of design knowledge.
```
...
- [ ] Version is `3.9.0` in `plugin.json`
- [ ] GitHub release `v3.9.0` exists and is tagged `Latest`
- [ ] README has install instructions for both methods
- [ ] `marketplace.json` is present in `.claude-plugin/`
- [ ] All 39 commands work in Claude Code
- [ ] Issue #4 is closed
